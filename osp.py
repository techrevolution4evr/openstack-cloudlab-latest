...
pc.defineParameter("release","OpenStack Release",
                   portal.ParameterType.STRING,"train",[("train","Train"),("stein","Stein"),("rocky","Rocky"),("queens","Queens"),("pike","Pike"),("ocata","Ocata"),("newton","Newton"),("mitaka","Mitaka"),("liberty","Liberty (deprecated)"),("kilo","Kilo (deprecated)"),("juno","Juno (deprecated)")],
                   longDescription="We provide OpenStack Train, Stein (Ubuntu 18.04, python3), Rocky, Queens (Ubuntu 18.04, python2), Pike, Ocata, Newton, Mitaka (Ubuntu 16.04, python2); Liberty (Ubuntu 15.10, python2); Kilo (Ubuntu 15.04, python2); or Juno (Ubuntu 14.10, python2).  OpenStack is installed from packages available on these distributions.")
...
grafanaInstructions = ""
if params.release in [ "pike","queens","rocky","stein","train" ]:
...
if params.fromScratch:
    ...
    image_tag_cn = '-OSCN'
    image_tag_nm = '-OSNM'
    if params.release in [ 'rocky','stein','train' ]:
...
if params.osNodeType == 'ibm8335':
    ...
    if params.release not in [ 'queens','rocky','stein','train' ]:
